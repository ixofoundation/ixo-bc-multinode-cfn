...
aws cloudformation create-stack --stack-name Blockchain-Stack-$TARGET_ENVIRONMENT --template-body file://templates/BlockchainStack.yaml  --parameters file://parameters/BlockchainStack.parameters.json --profile default --region $TARGET_REGION
